    ...
    progress: {
      ...
      lessons: [
        ...
        },
        {
          ...
          unitTitle: "Wild Animals",
          progress: 100,
        },
        {
          id: "7",
          title: "Elephants and Giraffes",
          unitTitle: "Wild Animals",
          progress: 100,
        },
        {
      ...
      challenges: [
        ...
        },
        {
          ...
          lessonTitle: "Animal Homes",
          progress: 100,
        },
        {
          id: "3",
          title: "Baby Animals Names",
          lessonTitle: "Baby Animals",
          progress: 90,
        },
        {
          id: "4",
          title: "Wild Animals Quiz",
          lessonTitle: "Lions and Tigers",
          progress: 100,
        },
        {
          id: "5",
          title: "Ocean Animals Matching",
          lessonTitle: "Dolphins and Whales",
          progress: 75,
        },
      ],
    },
              ...
              <div className="space-y-4">
                <div className="flex items-center justify-between">
                  ...
                  <p className="font-bold text-green-600">
                    {Math.round(
                      students.reduce(
                        (acc, student) => acc + student.progress.overall,
                        0
                      ) / students.length
                    )}
                    %
                ...
                <div className="flex items-center justify-between">
                  ...
                  <p className="font-bold text-green-600">
                    {
                      students.sort(
                        (a, b) => b.progress.overall - a.progress.overall
                      )[0]?.name
                    }
                  </p>
                </div>
                ...
                <div className="flex items-center justify-between">
                  ...
                  <p className="font-bold text-green-600">
                    {students.reduce(
                      (acc, student) =>
                        acc +
                        student.progress.lessons.filter(
                ...
                <div className="flex items-center justify-between">
                  ...
                  <p className="font-bold text-green-600">
                    {students.reduce(
                      (acc, student) =>
                        acc +
                        student.progress.challenges.filter(
          ...
          {selectedStudent ? (
            <Card className="border-none shadow-md rounded-2xl overflow-hidden">
                  ...
                  <div className="flex flex-col items-end">
                    <div className="flex items-center gap-2">
                      <p className="text-white font-bold text-xl">
                        {studentDetails?.progress.overall}%
                      </p>
              ...
              <CardContent className="p-0">
                ...
                >
                  ...
                  >
                    <div className="space-y-4">
                      {studentDetails?.progress.units.map((unit) => (
                        <div
                          key={unit.id}
                        ...
                        >
                          <div className="flex justify-between items-center mb-2">
                            ...
                            <Badge
                              variant={
                                unit.progress === 100 ? "default" : "outline"
                              }
                              className={
                                unit.progress === 100
                  ...
                  >
                    <div className="space-y-4">
                      {studentDetails?.progress.lessons.map((lesson) => (
                        <div
                          key={lesson.id}
                          className="border-2 border-gray-100 rounded-xl p-4 hover:border-purple-100 transition-colors"
                        >
                          <div className="flex justify-between items-center mb-2">
                            ...
                            <Badge
                              variant={
                                lesson.progress === 100 ? "default" : "outline"
                              }
                              className={
                                lesson.progress === 100
                                  ? "bg-green-100 text-green-600 hover:bg-green-200"
                  ...
                  >
                    <div className="space-y-4">
                      {studentDetails?.progress.challenges.map((challenge) => (
                        <div
                          key={challenge.id}
                          className="border-2 border-gray-100 rounded-xl p-4 hover:border-purple-100 transition-colors"
                        >
            ...
            <div className="flex flex-col items-center justify-center min-h-[400px] bg-white rounded-2xl shadow-md border-2 border-dashed border-gray-200">
              ...
              <p className="text-gray-500 text-center max-w-md">
                ...
                in units, lessons, and challenges
              </p>
            </div>
          )}
        </div>
