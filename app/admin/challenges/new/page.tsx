  ...
  return (
    <div className="space-y-8">
      <div>
        ...
        <p className="text-gray-600 mt-2">Design an interactive activity to make learning enjoyable</p>
      </div>
            ...
            <div className="grid grid-cols-1 gap-6 md:grid-cols-2">
              ...
              <div className="space-y-2">
                ...
                <Select value={formData.type} onValueChange={(value) => handleChange("type", value)}>
                  <SelectTrigger id="type" className="border-2 border-blue-200 rounded-xl">
            ...
            <div className="grid grid-cols-1 gap-6 md:grid-cols-2">
              <div className="space-y-2">
                ...
                <Select value={formData.lessonId} onValueChange={(value) => handleChange("lessonId", value)}>
                  <SelectTrigger id="lessonId" className="border-2 border-blue-200 rounded-xl">
                  ...
                  <TabsContent value="multiple-choice">
                    <div className="space-y-4">
                      <div className="space-y-2">
                        ...
                        <Input placeholder="Enter your question here" className="border-2 border-blue-200 rounded-xl" />
                        <p className="text-sm text-blue-600 flex items-center gap-1">
                          <Sparkles className="h-3 w-3" />
