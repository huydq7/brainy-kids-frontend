...
export default function FlashCardApp() {
  ...
  return (
    <div className="container py-6 space-y-8 max-w-7xl mx-auto">
        ...
        <div className="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-4 lg:grid-cols-6 gap-4">
          {userDecks.map((deck) => (
            <div key={deck.id} className="group relative">
              <div
                className="aspect-square rounded-2xl bg-gradient-to-br from-blue-50 to-blue-100 dark:from-blue-900/20 dark:to-blue-900/10 p-4 shadow-sm hover:shadow-md transition-all duration-200 ease-in-out border border-gray-200 dark:border-gray-800 flex flex-col items-center justify-center group-hover:scale-105 group-hover:border-blue-300 dark:group-hover:border-blue-700 cursor-pointer"
                onClick={() => router.push(`/flashcards/${deck.id}`)}
              >
                <Folder className="w-16 h-16 text-blue-500 mb-3 group-hover:text-blue-600 flex-shrink-0" />
          ...
          <div
            className="aspect-square rounded-2xl border-2 border-dashed border-gray-200 dark:border-gray-800 p-4 hover:border-blue-300 dark:hover:border-blue-700 transition-colors cursor-pointer flex flex-col items-center justify-center"
      ...
      <div className="space-y-6">
        <h2 className="text-xl font-semibold">Public Decks</h2>
        ...
        <div className="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-4 lg:grid-cols-6 gap-4">
          {publicDecks.map((deck) => (
            <div
              ...
              onClick={() => router.push(`/flashcards/${deck.id}`)}
            >
              <div className="aspect-square rounded-2xl bg-gradient-to-br from-green-50 to-green-100 dark:from-green-900/20 dark:to-green-900/10 p-4 shadow-sm hover:shadow-md transition-all duration-200 ease-in-out border border-gray-200 dark:border-gray-800 flex flex-col items-center justify-center group-hover:scale-105 group-hover:border-green-300 dark:group-hover:border-green-700">
                <Folder className="w-16 h-16 text-green-500 mb-3 group-hover:text-green-600 flex-shrink-0" />
                <div className="w-full">
                  <p className="text-sm font-medium text-center truncate">
                    {deck.name}
                  </p>
          ...
          {publicDecks.length === 0 && (
            <div className="col-span-full text-center p-8">
              <BookOpen className="w-12 h-12 mx-auto text-muted-foreground mb-4" />
              <p className="text-muted-foreground">No public decks available</p>
            </div>
          )}
        </div>
      </div>
